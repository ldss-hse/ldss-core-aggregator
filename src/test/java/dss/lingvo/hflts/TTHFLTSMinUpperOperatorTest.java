...
public class TTHFLTSMinUpperOperatorTest {
    private static TTHFLTSScale singleScale;
    private static TTHFLTSMinUpperOperator minUpper;

    @BeforeClass
    public static void runOnceBeforeClass() {
        String[] scaleString = {"n", "vl", "l", "m", "h", "vh", "p"};
        singleScale = new TTHFLTSScale(scaleString);
        minUpper = new TTHFLTSMinUpperOperator();
    }
    ...
    public void testCalculate1() throws Exception {
        ...
        String res = minUpper.calculate(new TTHFLTSAlternativeEstimation(x1H), singleScale);
        assertEquals(res, "m");
    }
    ...
    public void testCalculate2() throws Exception {
        ...
        String res = minUpper.calculate(new TTHFLTSAlternativeEstimation(x2H), singleScale);
        assertEquals(res, "l");
    }
    ...
    public void testCalculate3() throws Exception {
        ...
        String res = minUpper.calculate(new TTHFLTSAlternativeEstimation(x3H), singleScale);
        assertEquals(res, "l");
    }
}